...
class Generator(nn.Module):
    def __init__(self, FG):
        ...
        self.fc1 = nn.Sequential(
            nn.Linear(self.input_dim+self.discrete_code+self.continuous_code, 256),
            nn.BatchNorm1d(256),
            nn.ReLU(True))
        self.fc2 = nn.Sequential(
            nn.Linear(256, 256*5*6*5),
            nn.BatchNorm1d(256*5*6*5),
            nn.ReLU(True))

        self.layer1 = ConvT3d(256, 256, 3, 2, 0)
        self.layer2 = ConvT3d(256, 128, 3, 2, 1)
        self.layer3 = ConvT3d(128, 64, 3, 2, 1)
        self.layer4 = ConvT3d(64, 32, 3, 2, 2)
        self.layer5 = ConvT3d(32, 16, 1, 1, 0)
        self.layer6 = ConvT3d(16, 16, 1, 1, 0)
        self.layer7 = ConvT3d(16, 1, 1, 1, 0, batch_norm=False, activation=nn.Tanh())
...
class Discriminator(nn.Module):
    def __init__(self, FG):
        ...
        self.layer6 = Conv3d(256, 256, 3, 2, 1, activation=self.activation)
        self.layer7 = Conv3d(256, 256, 3, 2, 1, activation=self.activation)
...
class D(nn.Module):
    def __init__(self, FG):
        ...
        self.layer1 = Conv3d(1, 16, 3, 5, 1, activation=self.activation)
        self.layer2 = Conv3d(16, 32, 3, 2, 1, activation=self.activation)
        self.layer3 = Conv3d(32, 64, 3, 2, 1, activation=self.activation)
        self.layer4 = Conv3d(64, 128, 3, 2, 1, activation=self.activation)

        self.fc1 = nn.Sequential(
            nn.Linear(128*2*3*2, 256),
            nn.BatchNorm1d(256),
            nn.LeakyReLU(0.2, inplace=True))
        self.fc2 = nn.Linear(256,self.output_dim+self.continuous_code+self.discrete_code)
